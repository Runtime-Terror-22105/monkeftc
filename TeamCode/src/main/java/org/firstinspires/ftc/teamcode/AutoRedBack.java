...
public class AutoRedBack extends LinearOpMode {
    ...
    public static coord rightDepo = new coord(fromBack, 21.9, 4.71239, 0.8, 0.8, Math.toRadians(3));
    public static coord leftDepo = new coord(fromBack, 37.0, 4.71239, 2, 0.8, Math.toRadians(3));
