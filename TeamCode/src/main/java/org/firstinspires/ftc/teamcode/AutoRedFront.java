...
@Autonomous(name="2+0 Red Front Auto", group="concept")
...
//    public static volatile TwoPositions depositRightPositions = new TwoPositions(0.27, 1.0);
    ...
    public static double backDistance = 31;
    ...
    public void runOpMode() {
        ...
        7: Deposit pixel (wait), outtake in, and slides down.
        ...
        */
        ...
        switch(location) {
            case RIGHT:
                points[0] = new coord(0, 12.941, -6.003376302, 2, 2, Math.toRadians(3)); // place on purple pixel mark
                points[1] = new coord(5, 23.941, -5.83376302, 2, 2, Math.toRadians(3)); // place on purple pixel mark
                c=1;
                code[0] = 69;
                break;
            case MIDDLE:
        ...
        points[c] = new coord(32.22, -0.489, -4.71239, 1.2, 1.2, Math.toRadians(1));
        code[c] = -100;
        c++;
        points[c] = new coord(32.22, -0.489, -4.71239, 1.2, 1.2, Math.toRadians(1));
        code[c] = -100000;
